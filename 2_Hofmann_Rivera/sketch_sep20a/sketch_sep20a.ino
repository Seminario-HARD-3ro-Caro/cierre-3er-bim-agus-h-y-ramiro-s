...
void nextLED() {
  ...
  switch (currentLED) {
    case 0:
      digitalWrite(amarillo, HIGH);  // LED 0 (amarillo)
      break;
    case 1:
      digitalWrite(azul, HIGH);      // LED 1 (azul)
      break;
    case 2:
      digitalWrite(rojo, HIGH);      // LED 2 (rojo)
      break;
    case 3:
      digitalWrite(verde, HIGH);     // LED 3 (verde)
      break;
  }

  currentLED = (currentLED + 1) % 4;  // Hace que vuelva a 0 después del 3
}
